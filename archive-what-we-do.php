				...
				<div class="large-2 columns">
					<div class="whatWeDoMobile">
						<?php
			    			...
			    			p2p_type( 'quote2what' )->each_connected( $what );
			    			if ( $what->have_posts() ) {
				    	...
				    	<div class="text">
				    		...
				    		<div class="hide-for-small">
					    		<div class="large-4 columns">
					    			<p><img src="<?php global $post; $image1 = get_post_meta( $post->ID, '_cmb_wwd1', true ); echo $image1;  ?>"></p>
								</div>
					    		<div class="large-4 columns">
					    			<p><img src="<?php global $post; $image2 = get_post_meta( $post->ID, '_cmb_wwd2', true ); echo $image2;  ?>"></p>
								</div>
					    		<div class="large-4 columns">
					    			<p><img src="<?php global $post; $image3 = get_post_meta( $post->ID, '_cmb_wwd3', true ); echo $image3;  ?>"></p>
								</div>
				    		</div>
				    		</div>
							<?php endif; ?>
